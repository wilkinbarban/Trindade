...
import com.trindade.app.contract.infrastructure.Serializer.kotlinxSerializationJson
...
class ApiClient(
    ...
    companion object {
        protected const val BASE_URL_KEY: String = "com.trindade.app.contract.baseUrl"
        @Deprecated(
        ...
        val defaultBasePath: String by lazy {
            System.getProperties().getProperty(BASE_URL_KEY, "https://trindademasas.duckdns.org")
        }
    }
}
